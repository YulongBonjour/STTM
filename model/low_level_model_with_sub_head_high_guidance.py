...
class Voxel2StableDiffusionModel(torch.nn.Module):
    def __init__(self, voxel_num_dict= {1: 15724, 2: 14278, 5: 13039, 7: 12682}, h=4096, n_blocks=4,
    ...
    def get_subject_proj(self, x, sub_id):
        ...
        for i in range(self.input_n_blocks):
            ...
            residual = x
        return x
    def forward(self, x,sub_id,high_feature=None, is_train=False):
        null_emb=False
